...
public class DimenXmlsImpl implements DimenXmls {
    ...
    public void init(String path) throws IOException, SAXException, ParserConfigurationException {
        ...
        DimenXmlsImpl.SaxHandler dh = new DimenXmlsImpl.SaxHandler();
        parser.parse(path, dh);
    }
    @Override
    public Map<String, String> getDimenValues() {
        return map;
    }

    @Override
    public void addDimenValue(String key, String value) {

    }

    @Override
    @Deprecated
    public String iscontainsDimenValue(String value) {
        return null;
    }
